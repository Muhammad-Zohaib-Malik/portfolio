...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white relative">
      ...
      {/* Spinning Text */}
      <div className="absolute top-20 left-16 z-10 hidden lg:block">
          ...
          <Card className="relative overflow-hidden bg-zinc-900/60 backdrop-blur-md rounded-2xl sm:rounded-3xl p-6 sm:p-8 w-full max-w-md mx-auto md:mx-0 md:sticky md:top-24 h-fit border-zinc-800/50">
            ...
            <CardContent className="flex flex-col items-center text-center">
              <div className="w-40 h-40 rounded-2xl overflow-hidden mb-6 border-2 border-emerald-500/20 shadow-lg shadow-emerald-500/10">
                <img
                  src="/profile.jpg"
                  alt="Muhammad Zohaib - Full Stack Developer"
                  className="w-full h-full object-cover"
                />
              </div>

              {/* Name with terminal cursor */}
              <span className="text-transparent bg-gradient-to-r from-emerald-400 via-cyan-400 to-emerald-400 bg-clip-text animate-gradient text-3xl font-bold mb-1">
                Muhammad Zohaib
              </span>
              ...
              <div className="w-full rounded-lg bg-zinc-800/50 border border-zinc-700/30 p-3 mb-4">
                <div className="flex items-center gap-2 text-xs font-mono">
                  ...
                  <span className="inline-block w-1.5 h-4 bg-emerald-400 animate-cursor-blink ml-1" />
                </div>
              </div>
            </CardContent>
              ...
              <a href="/MyCV.pdf" download>
                <ShimmerButton className="shadow-2xl">
                  <span className="text-sm font-mono font-medium tracking-tight text-white lg:text-base flex items-center gap-2">
                    <span className="text-emerald-400">&gt;</span> Download CV
                  </span>
                </ShimmerButton>
              </a>
            </CardFooter>
          ...
          <div className="flex-1 space-y-10">
            ...
            >
              <p className="text-zinc-600 text-sm font-mono">
                <span className="text-zinc-700">{"// "}</span>© {new Date().getFullYear()} Zohaib
